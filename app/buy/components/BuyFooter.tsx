            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div className="md:col-span-2">
                        <Link href="/buy" className="flex items-center gap-2 font-bold text-xl mb-4">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-muted-foreground">
                            <li><Link href="#activation" className="hover:text-foreground transition-colors">Процесс активации</Link></li>
                            <li><Link href="#products" className="hover:text-foreground transition-colors">Тарифы</Link></li>
                            <li>
